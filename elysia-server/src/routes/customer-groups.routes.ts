...
export const customerGroupRoutes = new Elysia({
  ...
  .get(
    ...
    async ({ query }) => {
      ...
      const total = await customerGroupService.countCustomerGroupsWithFilters(
        filters
      );
  ...
  .get(
    ...
    async ({ query }) => {
      ...
      const groups = await customerGroupService.listCustomerGroups(
        limit,
        offset
      );
  ...
  .get(
    ...
    async ({ params: { workspaceId } }) => {
      const groups = await customerGroupService.getGroupsByWorkspace(
        workspaceId
      );
      return groups;
    },
  ...
  .get(
    ...
    async ({ params: { id }, query }) => {
      ...
      const members = await customerGroupService.getGroupMembers(
        id,
        limit,
        offset
      );
...
export const adminCustomerGroupRoutes = new Elysia({
  ...
  .delete(
    "/bulk",
    async ({ body }) => {
      const deletedCount = await customerGroupService.bulkDeleteCustomerGroups(
        body.groupIds
      );
      return { deletedCount };
    },
  ...
  .delete(
    "/:id/members/bulk",
    async ({ params: { id }, body }) => {
      const removedCount = await customerGroupService.bulkRemoveMembers(
        id,
        body.leadIds
      );
      return { removedCount };
