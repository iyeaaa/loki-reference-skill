...
export { createB2BHunterIndustryAgent } from "./shell/agents/b2b-hunter-industry-agent"
export { generateB2BHunterIndustryPrompt } from "./shell/agents/b2b-hunter-industry-agent/prompts"
