...
import { Send, Trash, Loader2, BarChart } from "lucide-react";
    ...
    <NodeStatusIndicator status={sending ? "loading" : "initial"} variant="border">
      <BaseNode className={`w-96 ${borderClass}`}>
        ...
        <BaseNodeContent>
          ...
          {!sent ? (
            <Button className="nodrag mt-2" disabled={sending || recipients.length === 0} onClick={handleBulkSend}>
              {sending ? (
                <>
            ...
            <div className="mt-2 flex items-center gap-2">
              ...
              <Button variant="outline" size="sm" className="ml-auto nodrag" onClick={() => setShowMetrics(!showMetrics)}>
