  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    headers.forEach((header, index) => {
      ...
      if (lowerHeader.includes("company") || lowerHeader.includes("회사")) {
        ...
        lowerHeader === "primaryemail" ||
        lowerHeader === "primary_email"
      ) {
        lead.primaryEmail = value;
      } else if (
        lowerHeader === "primaryphone" ||
        lowerHeader === "primary_phone"
      ) {
        lead.primaryPhone = value;
      } else if (
        lowerHeader === "secondaryemail" ||
        lowerHeader === "secondary_email"
      ) {
        lead.secondaryEmail = value;
      } else if (
        lowerHeader === "secondaryphone" ||
        lowerHeader === "secondary_phone"
      ) {
        lead.secondaryPhone = value;
      } else if (
        lowerHeader.includes("primary") &&
        ...
        lowerHeader.includes("secondary") &&
        lowerHeader.includes("email")
      ) {
        lead.secondaryEmail = value;
      } else if (
        ...
        // 단순히 "email"만 있으면 primary로 간주
        lead.primaryEmail = value;
      } else if (
        lowerHeader.includes("phone") &&
        !lowerHeader.includes("secondary")
      ) {
        // 단순히 "phone"만 있으면 primary로 간주
        lead.primaryPhone = value;
      }
    });
