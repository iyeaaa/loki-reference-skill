...
CREATE TYPE "public"."email_thread_status_enum" AS ENUM('active', 'archived', 'snoozed');--> statement-breakpoint
...
CREATE TABLE "email_threads" (
	...
	"status" "email_thread_status_enum" DEFAULT 'active' NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE INDEX "email_threads_workspace_id_idx" ON "email_threads" USING btree ("workspace_id");--> statement-breakpoint
CREATE INDEX "email_threads_lead_id_idx" ON "email_threads" USING btree ("lead_id");--> statement-breakpoint
CREATE INDEX "email_threads_last_activity_idx" ON "email_threads" USING btree ("last_activity_at");--> statement-breakpoint
CREATE INDEX "emails_workspace_id_idx" ON "emails" USING btree ("workspace_id");--> statement-breakpoint
CREATE INDEX "emails_user_email_account_id_idx" ON "emails" USING btree ("user_email_account_id");--> statement-breakpoint
