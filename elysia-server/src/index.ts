...
import {
  adminCustomerGroupRoutes,
  customerGroupRoutes,
} from "./routes/customer-groups.routes";
import { departmentsRoutes } from "./routes/departments.routes";
import {
  adminEmailAccountRoutes,
  emailAccountRoutes,
} from "./routes/email-accounts.routes";
import {
  adminEmailTemplateRoutes,
  emailTemplateRoutes,
} from "./routes/email-templates.routes";
