...
export const AVAILABLE_COLUMNS: ColumnDefinition[] = [
  ...
  { id: "contactName", label: "담당자명", isDefault: true, canHide: false },
  { id: "email", label: "이메일", isDefault: true, canHide: true },
  { id: "websiteUrl", label: "웹사이트", isDefault: true, canHide: true },
  { id: "leadStatus", label: "상태", isDefault: true, canHide: false },
  { id: "createdAt", label: "생성일", isDefault: true, canHide: true },
