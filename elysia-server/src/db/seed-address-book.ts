...
import { addressBookGroups, addressBookContacts } from './schema'
...
const fashionAgencies = [
  {
    ...
    description: '패션 브랜드를 전문으로 하는 인플루언서 마케팅 에이전시로, 미국에 본사를 두고 있으며 New Balance, Uniqlo 등 패션 브랜드와 협력하여 소셜 미디어 마케팅 서비스를 제공하는 에이전시입니다.',
  ...
  },
  {
    ...
    industryType: '패션의류',
    productCategory: '에이전시',
    description: '패션 마케팅 전문 에이전시로 미국에서 활동하며, 패션 브랜드의 디지털 마케팅, SEO, PPC 광고, 소셜 미디어 관리 등을 통해 브랜드 성장을 지원하는 에이전시 서비스를 제공합니다.',
  ...
  },
  {
    ...
    industryType: '패션의류',
    productCategory: '에이전시',
    description: '런던에 본사를 두고 있지만 미국 시장에서도 활동하는 패션 PR 및 마케팅 에이전시로, 패션 브랜드를 위한 전략적 마케팅 및 커뮤니케이션 서비스를 제공하는 전문 에이전시입니다.',
  ...
  },
  {
    ...
    industryType: '패션의류',
    productCategory: '에이전시',
    description: '뉴욕에 본사를 둔 패션 전문 PR 에이전시로, 패션 디자이너와 브랜드를 위한 브랜딩, 셀러브리티 PR, 에디토리얼 및 이벤트 중심의 퍼블릭 릴레이션즈 서비스를 제공하는 에이전시입니다.',
  ...
  },
  {
    ...
    industryType: '패션의류',
    productCategory: '에이전시',
    description: '뉴욕에 본사를 둔 Forbes 선정 미국 최고의 PR 회사 중 하나로, 패션 브랜드를 포함한 다양한 클라이언트에게 전문적인 PR 및 마케팅 에이전시 서비스를 제공합니다.',
...
const techCompanies = [
  {
    ...
    description: '세계 최대의 검색 엔진 및 클라우드 서비스 제공업체로, AI, 머신러닝, 광고 기술 등 다양한 혁신적인 기술 솔루션을 제공하는 글로벌 기술 기업입니다.',
  ...
  },
  {
    ...
    description: '전 세계적으로 사용되는 Windows 운영체제와 Office 제품군, Azure 클라우드 서비스를 제공하는 글로벌 소프트웨어 및 클라우드 기술 기업입니다.',
  ...
  },
  {
    ...
    description: 'iPhone, iPad, Mac 등 혁신적인 하드웨어 제품과 iOS, macOS 등의 운영체제를 개발하는 세계적인 기술 기업입니다.',
  ...
  },
  {
    ...
    description: 'Facebook, Instagram, WhatsApp을 운영하며 메타버스 기술 개발에 주력하는 소셜 미디어 및 가상현실 기술 기업입니다.',
  ...
  },
  {
    ...
    description: '세계 최대의 이커머스 플랫폼이자 AWS 클라우드 서비스를 제공하는 글로벌 기술 및 물류 기업입니다.',
...
const consultingFirms = [
  {
    ...
    description: '세계 최고의 경영 컨설팅 회사 중 하나로, 전략, 운영, 조직, 기술 등 다양한 분야에서 글로벌 기업들에게 컨설팅 서비스를 제공합니다.',
  ...
  },
  {
    ...
    industryType: '컨설팅',
    productCategory: '전략컨설팅',
    description: '혁신적인 비즈니스 전략과 디지털 트랜스포메이션 솔루션을 제공하는 글로벌 경영 컨설팅 회사입니다.',
  ...
  },
  {
    ...
    industryType: '컨설팅',
    productCategory: '전략컨설팅',
    description: '결과 중심의 컨설팅 접근법으로 유명한 글로벌 경영 컨설팅 회사로, 전략, 운영, 조직 개발 등의 서비스를 제공합니다.',
  ...
  },
  {
    ...
    description: '감사, 컨설팅, 세무, 리스크 관리 등 다양한 전문 서비스를 제공하는 글로벌 전문 서비스 기업입니다.',
  ...
  },
  {
    ...
    industryType: '컨설팅',
    productCategory: '종합컨설팅',
    description: '감사, 세무, 컨설팅 서비스를 제공하는 글로벌 전문 서비스 네트워크로, 다양한 산업 분야의 기업들에게 전문적인 솔루션을 제공합니다.',
