...
export function CompanyMetricsModal({
  ...
  const getEmailStatusIcon = (status: string) => {
    switch (status) {
      ...
      case "opened":
        return <MailOpen className="w-4 h-4 text-blue-600" />
      case "clicked":
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-3">
            <div>
              <h2 className="text-xl font-bold">{companyData.companyName}</h2>
              <p className="text-sm text-muted-foreground">{companyData.emailAddress}</p>
            </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div>
                  <p className="text-sm text-muted-foreground">현재 단계</p>
                  <p className="font-medium">
                    Step {companyData.currentStep}/{companyData.totalSteps}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">첫 발송</p>
                  <p className="font-medium">
                ...
                <div>
                  <p className="text-sm text-muted-foreground">마지막 발송</p>
                  <p className="font-medium">
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-600">{companyData.emailsSent}</div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground">전달</p>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-600">{companyData.emailsOpened}</div>
                  <p className="text-sm text-muted-foreground">오픈</p>
                </div>
                <div className="text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <Progress value={companyData.openRate} className="h-2" />
                  </div>
                  <div>
                    <div className="flex justify-between text-sm mb-2">
                      <span>클릭률</span>
                    ...
                    <Progress value={companyData.clickRate} className="h-2" />
                  </div>
                </div>
                <div className="space-y-4">
                  <div>
                    ...
                    <Progress value={companyData.replyRate} className="h-2" />
                  </div>
                  <div>
                    <div className="flex justify-between text-sm mb-2">
                      <span>반송률</span>
                    ...
                    <Progress value={companyData.bounceRate} className="h-2" />
                  </div>
                </div>
              </div>
            </CardContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {companyData.avgTimeToOpen && (
                    <div className="text-center">
                      ...
                      <p className="text-sm text-muted-foreground">평균 오픈 시간</p>
                    </div>
                  )}
                  {companyData.avgTimeToReply && (
                    <div className="text-center">
                      ...
                      <p className="text-sm text-muted-foreground">평균 답장 시간</p>
                    </div>
                  )}
                </div>
              </CardContent>
                  ...
                  <div key={index} className="border rounded-lg p-4">
                    ...
                    <div className="flex items-center gap-4 text-sm">
                      <div className="flex items-center gap-1">
                        <MailOpen className="w-3 h-3 text-blue-600" />
