  ...
  if (isMobile) {
    return (
      <Sheet onOpenChange={setOpenMobile} open={openMobile} {...props}>
        <SheetContent
          className="bg-white p-0 text-sidebar-foreground dark:bg-gray-950 [&>button]:hidden"
          data-mobile="true"
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      className={cn(
        "flex h-10 shrink-0 items-center rounded-md px-2 font-semibold text-sidebar-foreground/70 text-sm outline-hidden ring-sidebar-ring transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
