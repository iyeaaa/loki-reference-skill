...
async function seed() {
  ...
  try {
    ...
    const groupMemberSeeds = [
      { groupId: insertedGroups[0].id, leadId: insertedLeads[1].id, addedBy: insertedUsers[0].id },
      { groupId: insertedGroups[0].id, leadId: insertedLeads[2].id, addedBy: insertedUsers[0].id },
      { groupId: insertedGroups[1].id, leadId: insertedLeads[0].id, addedBy: insertedUsers[0].id },
      { groupId: insertedGroups[1].id, leadId: insertedLeads[4].id, addedBy: insertedUsers[0].id },
      { groupId: insertedGroups[2].id, leadId: insertedLeads[3].id, addedBy: insertedUsers[1].id },
    ]
