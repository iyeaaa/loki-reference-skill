...
json
{
"industry": "BEAUTY", // Q1. 산업군 (Industry) - _Determines Market Scenario_
"targetType": "B2B", // Q2. 타겟 고객 (Target Audience) - _Determines Email Tone_
"targetCountry": "JP", // Q3. 희망 진출 국가 (Target Country) - _Prioritizes List_
"exportExp": "INITIAL" // Q4. 수출 경험 (Export Experience) - _Determines Guide/Checklist_
}
...
_Used to determine the 'Market Strategy Scenario' group._
...
_Used to customize email strategy tone in the result._
...
_Used to prioritize the recommendation list or add specific tag._
...
_Used to determine 'rinda's Direction' & 'Checklist' content._
...
"experienceLabel": "First time Export"
    ...
    // [Section 1] rinda's Direction & Checklist (Determined by Q4 Logic)
    // 수출 경험(Q4)에 따라 달라지는 고정 가이드 데이터
    "rindaSolution": {
      "directionTitle": {
        "kr": "수출 초보시군요? 린다가 바이어 발굴부터 도와드려요.",
        "en": "New to export? rinda helps from buyer sourcing to contact."
      },
      "actionSteps": [
        {
          "step": 1,
    ...
    "recommendedMarkets": [
      {
        ...
        // 2. How to sell (rinda's Strategy)
        "salesStrategy": {
