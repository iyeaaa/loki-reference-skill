...
export const selectedWorkspaceIdAtom = atomWithStorage<string | null>("ws_selected", null)
export const flowStateByWorkspaceAtom = atomWithStorage<Record<string, FlowState>>("ws_flows", {})
