...
function Sidebar({
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-white dark:bg-gray-950 text-sidebar-foreground p-0 [&>button]:hidden"
          style={
            {
  ...
  return (
    <div
      ...
      style={
        {
          "--sidebar-width-val": SIDEBAR_WIDTH,
          "--sidebar-width-icon-val": SIDEBAR_WIDTH_ICON,
        } as React.CSSProperties
      }
    >
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-40 hidden h-screen transition-[left,right,width] duration-200 ease-linear sm:flex",
          side === "left"
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground/70 ring-sidebar-ring flex h-10 shrink-0 items-center rounded-md px-2 text-sm font-semibold outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
